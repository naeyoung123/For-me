...
router.get('/store/tampon/:listId', function (request, response) {
    db.query(`SELECT * FROM tampon`, function(err, count){
        ...
        var head = `
            ...
            for(i = first; i < last + 1; i++){
                paging += `
                    <li class="page-item"><a class="page-link" href="/store/tampon/${i}">${i}</a></li>
                `
            }  
